...
- Implemented Swagger-backed methods: `/hotel/hotelSearch`, `/hotel/homePage/stayBenefitPeriods`, `/pms/hotelinfobyidapp`, `/booking/order` Airhost booking creation, `/booking/order/sendPaymentLink`, and `/pms/pay4order`.
